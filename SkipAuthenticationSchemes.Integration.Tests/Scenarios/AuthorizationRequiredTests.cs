...
using SkipAuthenticationSchemes.Integration.Tests.Security;
using SkipAuthenticationSchemes.Integration.Tests.Constants;
using SkipAuthenticationSchemes.Integration.Tests.Controllers;
using Xunit;
...
namespace SkipAuthenticationSchemes.Integration.Tests.Scenarios
{
	public class AuthorizationRequiredTests
	{
		...
		[InlineData(AuthenticationType.MixedMode, true)]
		[InlineData(AuthenticationType.MixedMode, false)]
